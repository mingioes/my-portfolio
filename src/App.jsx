...
const data = {
  ...
  projects: [
      ...
      stories: [
        {
          step: "상황",
          title: "해결해야 했던 과제",
          body: "Snapdragon NPU에서 AI 모델을 구동하려면 SDK 버전마다 다른 호환성 오류를 해결해야 했습니다. 국내 레퍼런스가 거의 없어 공식 문서만으로는 해결이 안 되는 케이스가 반복됐고, 같은 오류가 팀원 사이에서 중복 발생하는 비효율도 있었습니다.",
        },
        {
          step: "행동",
          title: "이슈 트래킹 체계 설계 & 글로벌 파트너 소통",
          body: "총 10여 건의 SDK 이슈를 ① 이슈 재현 → ② 로그·환경 정보 정리 → ③ 해결책 검증·문서화의 3단계로 체계화했습니다. 팀 공유 노션 문서에 이슈별 원인·해결책을 누적 관리하여 같은 오류의 중복 발생을 원천 차단했습니다. 내부에서 해결이 어려운 이슈는 로그와 재현 경로를 정리해 Qualcomm 본사 엔지니어에게 영어로 질의했고, 기술 피드백을 팀 내 한국어로 재정리해 공유하는 역할도 맡았습니다.",
        },
        {
          step: "분석",
    ...
    },
    {
      ...
      title: "뿌리오 마케팅 솔루션",
      org: "다우기술 기업연계",
      subtitle: "텍스트 콘텐츠 분석 기반 마케팅 이미지 자동 생성 서비스",
      ...
      highlights: [
        ...
        "실제 비즈니스 시나리오(학회 워크숍·사내 행사 등) 기반 요구사항 도출 및 기능 명세화",
      ...
      stories: [
        ...
        },
        {
          ...
          body: "뿌리오 MMS 발송 규격 12개 항목을 하나씩 분석하여 체크리스트로 문서화했습니다. 이후 학회 워크숍·사내 행사·소매 할인 이벤트 등 실제 비즈니스 시나리오 6가지를 직접 설계하고, 각 시나리오마다 이미지 생성부터 발송 규격 준수 여부까지 전 단계를 검증했습니다. 이 과정에서 규격 위반 가능성이 있는 3개 경우를 사전에 발견하고 로직을 수정하여 운영 리스크를 차단했습니다.",
        },
        {
          step: "분석",
